...
#define JOYSTICK_PIN1       4
#define JOYSTICK_PIN2       3
#define JOYSTICK_PIN3      16


#define X_STEP_PIN         23
#define X_DIR_PIN          24
#define X_ENABLE_PIN       22
#define X_MIN_PIN          -1   // Min and max are now swapped
#define X_MAX_PIN          35   //2 //Max endstops default to disabled "-1", set to commented value to enable.

#define Y_STEP_PIN         26
#define Y_DIR_PIN          27
#define Y_ENABLE_PIN       25
#define Y_MIN_PIN          -1   // Min and Max are swapped
...
#define HEATER_0_PIN       2     //HOTEND
#define HEATER_1_PIN       3     //HOTBED
