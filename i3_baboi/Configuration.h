...
//#define _AXIS_STEP_PER_UNIT {107.296, 107.526, 4063.440, 109.000} // Colin Wales i3 settings
...
#define _MAX_FEEDRATE {200, 200, 3, 60}       // (mm/sec)    set z from 2 to 3 - CL
#define _HOMING_FEEDRATE {2000,2000,100}      // (mm/min) !
...
#define _ACCELERATION 800         // Axis Normal acceleration mm/s^2
#define _RETRACT_ACCELERATION 2000 // Extruder Normal acceleration mm/s^2
#define _MAX_XY_JERK 8.0
#define _MAX_Z_JERK 0.4
//#define _MAX_START_SPEED_UNITS_PER_SECOND {25.0,25.0,0.2,10.0}
#define _MAX_ACCELERATION_UNITS_PER_SQ_SECOND {1000,1000,50,2500}    // X, Y, Z and E max acceleration in mm/s^2 for printing moves or retracts
...
#define PID_INTEGRAL_DRIVE_MAX 110 // (80) too big, and heater will lag after changing temperature, too small and it might not compensate enough for long-term errors
...
#define HEATER_DUTY_FOR_SETPOINT(setpoint) ((int)((120L*(long)setpoint)>>8)-27)  //was 187
